...
export const projectsData: Record<string, Project> = {
  "earth2echo": {
    ...
    futureEnhancements: [
      "Creator workflow: convert generated audio → editable MIDI (MT3 integration)",
      "First-party YouTube frame API for robust frame access",
      "Lower-latency Lyria streaming mode to reduce adaptation lag",
      "Multi-user sessions and collaborative composition features"
    ]
  },
  "keylogger": {
    id: "keylogger",
